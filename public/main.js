...
let countPlayer = () => {
  ...
  if (playerHand.length === 3) {
    playerCount = playerHand[0].value + playerHand[1].value + playerHand[2].value
    showPlayer.textContent = playerCount
  }
  if (playerHand.length === 4) {
    playerCount = playerHand[0].value + playerHand[1].value + playerHand[2].value + playerHand[3].value
    showPlayer.textContent = playerCount
  }
